...
void  setup (void) 
{
	...
	op2i[OP_BCC_REL ] = (decode_t){"BCC", AM_REL , 1, 22, {FLG_NONE, FLG_NONE, FLG_NONE               }};
	op2i[OP_BCS_REL ] = (decode_t){"BCS", AM_REL , 1, 22, {FLG_NONE, FLG_NONE, FLG_NONE               }};
	op2i[OP_BEQ_REL ] = (decode_t){"BEQ", AM_REL , 1, 22, {FLG_NONE, FLG_NONE, FLG_NONE               }};
	...
	op2i[OP_BMI_REL ] = (decode_t){"BMI", AM_REL , 1, 22, {FLG_NONE, FLG_NONE, FLG_NONE               }};
	op2i[OP_BNE_REL ] = (decode_t){"BNE", AM_REL , 1, 22, {FLG_NONE, FLG_NONE, FLG_NONE               }};
	op2i[OP_BPL_REL ] = (decode_t){"BPL", AM_REL , 1, 22, {FLG_NONE, FLG_NONE, FLG_NONE               }};
	op2i[OP_BRK_IMP ] = (decode_t){"BRK", AM_IMP , 1,  7, {FLG_NONE, FLG_I,    FLG_NONE               }};
	op2i[OP_BVC_REL ] = (decode_t){"BVC", AM_REL , 1, 22, {FLG_NONE, FLG_NONE, FLG_NONE               }};
	op2i[OP_BVS_REL ] = (decode_t){"BVS", AM_REL , 1, 22, {FLG_NONE, FLG_NONE, FLG_NONE               }};
